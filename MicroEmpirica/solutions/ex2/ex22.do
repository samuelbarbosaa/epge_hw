...
egen id_fam = concat(v0102 v0103 v0403)
*bysort id_fam: egen n_filhos = total(cond_fam==3 & idade<18)
*replace n_filhos = 0 if cond_fam >= 3	

egen n_filhos = sum(cond_fam==3 & idade<18), by (id_fam)
...
keep v0101 v0102 v0103 mulher idade idade2 cond_fam casal anos_estudo ///
     pia mulher_casal n_filhos n_filhos_mulher ind_renda log_renda  ///
	 peso estrato psu id_fam
