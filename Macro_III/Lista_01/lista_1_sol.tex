...
de consumo somente até 2013. Além disso, de 1994 para 1995 a variação do consumo destoa do restante da série.
Devido à baixa quantidade de observações (19), este \texit{outlier} altera significativamente a média do período.
...
de referência (1994 a 2013). No caso da Selic, o retorno observado foi de 7,08\% ao ano. 
Já o retorno médio real observado do Ibovespa foi de 10,73\% ao ano. Desta forma, o
prêmio de risco observado na comparação entre estes ativos foi de 3,66\% ao ano.

Para obter estimativas no modelo e compará-las com os dados observados,
criamos um \textit{grid} de $n=1000$ pontos para $\beta \in [0.7, 0.99]$ e $\sigma \in [0, 10]$.
Aos valores de $\beta  = 0.9767$ e $\sigma = 0.72$, o modelo retorna o prêmio de risco
